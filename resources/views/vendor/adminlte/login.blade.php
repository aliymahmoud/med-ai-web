...
@section('body')
    <div class="login-box">
        <div class="login-logo">
            <img src="{{ asset('vendor/adminlte/dist/img/AdminLTELogo.png') }}" alt="" class="brand-image img-circle elevation-3">
            <a href="{{ $dashboard_url }}">{!! config('adminlte.logo', '<b>MED-</b>AI') !!}</a>
        </div>
        <div class="card">
